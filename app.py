...
def page_deckblatt():
    ...
    st.markdown("""
    <div class="meta-row">
        <div class="meta-item"><span>🏫</span> Data Science Institut</div>
        <div class="meta-item"><span>📅</span> 18. Juli 2026</div>
    ...
    team = [
        ...
        {"name": "Ramzi Amara", "rolle": "Streamlit / ML / Visualisierung",  "detail": "Streamlit-Layout · Machine Learning · Plotly-Diagramme · CSS-Design",     "icon": "👤", "color": C["violet"]},
...
def page_projektziel():
    ...
    <div class="sec-t">
        ...
        <span class="ttl">Dashboard-Aufbau — 5 Analyseseiten + Machine Learning</span>
    </div>""", unsafe_allow_html=True)
    ...
    with ml1:
        ...
        <div class="info-block">
            <ul class="page-list">
                <li>
                    <span class="pl-num" style="background:{C['rose']};">6</span>
                    <div>
                        <strong style="color:#e2e8f0;">Churn Prediction</strong>
                        <div class="pl-desc">Modell-Erklärung · Random Forest · XGBoost · Logistic Regression · Feature Importance</div>
                    </div>
                </li>
                <li>
    ...
    with ml2:
        ...
        <div class="info-block">
            <ul class="page-list">
                <li>
                    <span class="pl-num" style="background:{C['pink']};">8</span>
                    <div>
                        <strong style="color:#e2e8f0;">Kundensegmentierung</strong>
                        <div class="pl-desc">RFM-Analyse · K-Means Clustering · Kundengruppen · Marketing-Empfehlungen</div>
                    </div>
                </li>
            </ul>
        </div>""", unsafe_allow_html=True)
...
VALID_PASS = st.secrets.get("auth", {}).get("password", "admin123")
